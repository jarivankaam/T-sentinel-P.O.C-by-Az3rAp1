...
public class SimpleMqttClient : IDisposable
{
    ...
    public static SimpleMqttClient CreateSimpleMqttClientForHiveMQ(string clientId)
    {
        ...
        {
            Host = "d876158e4c104998a90f192eaab2b506.s1.eu.hivemq.cloud", // maak eventueel een account aan bij hivemq als dit problemen geeft.
            Port = 8883,
            ...
            TimeoutInMs = 100_000, // Standaard time-out bij het maken van een verbinding (5 seconden)
            UserName = "hivemq.webclient.1736429079800",
            Password = "0@j%es35I&Q1HCB,obVw"
        });
